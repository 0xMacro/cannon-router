...
import "../src/fixtures/SampleRouter.sol";
...
contract TestProxySetup is Test {
    ...
    function testUnknownSelector() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(SampleRouter.UnknownSelector.selector, selector));
